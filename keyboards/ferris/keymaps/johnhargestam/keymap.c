...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _____,   SE_7,    SE_8,    SE_9,    FN_NWIN, KC_DOWN, KC_RGHT, KC_DEL,  KC_LGUI, _____,
    SE_0,    SE_1,    SE_2,    SE_3,    FN_AWIN, KC_TAB,  KC_ESC,  KC_BSPC, KC_LCTL, CW_TOGG,
    _____,   SE_4,    SE_5,    SE_6,    FN_PWIN, KC_UP,   KC_LEFT, KC_ENT,  KC_LALT, _____,
